# 🌍 Seven Wonders of the World — Interactive Guide
...
- JavaScript enabled for slideshow, maps, and form validation  

- (Wonder pages still load without JS, but maps + slideshow won’t)
